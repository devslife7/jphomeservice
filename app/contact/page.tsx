...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with JP Home Services for a free estimate. Serving Virginia, DC, and Maryland.",
}
    ...
    <section className="py-16 md:py-24 lg:py-32">
      <div className="my-container">
        ...
        <div className="mb-12 flex flex-col items-center text-center md:mb-16">
          ...
          <h1 className="font-roboto text-2xl font-bold tracking-tight text-foreground sm:text-3xl md:text-4xl">
            Get in Touch
          </h1>
